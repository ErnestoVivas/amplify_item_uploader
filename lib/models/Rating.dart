...
class Rating {
  ...
  const Rating._internal({required key, required value}): _key = key, _value = value;
  
  factory Rating({required String key, required double value}) {
  ...
  Rating copyWith({String? key, double? value}) {
    return Rating._internal(
      key: key ?? this.key,
      value: value ?? this.value);
  }
  
  Rating copyWithModelFieldValues({
