...
class Feedback extends Model {
  ...
  Map<String, Object?> toMap() => {
    'id': id, 'contentKey': _contentKey, 'feedback': _feedback, 'createdAt': _createdAt, 'updatedAt': _updatedAt
  };

  static final QueryModelIdentifier<FeedbackModelIdentifier> MODEL_IDENTIFIER = QueryModelIdentifier<FeedbackModelIdentifier>();
  static final QueryField ID = QueryField(fieldName: "id");
  static final QueryField CONTENTKEY = QueryField(fieldName: "contentKey");
  static final QueryField FEEDBACK = QueryField(fieldName: "feedback");
...
class _FeedbackModelType extends ModelType<Feedback> {
 ...
 */
@immutable
class FeedbackModelIdentifier implements ModelIdentifier<Feedback> {
  final String id;
